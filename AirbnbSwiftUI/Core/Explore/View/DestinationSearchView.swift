        ...
        VStack {
            ...
            VStack(alignment: .leading) {
                if selectedOption == .location {
                    ...
                    CollapsedPickerView(title: "Where to?", description: "Search destinations")
                }
            ...
            .onTapGesture {withAnimation(.snappy) {selectedOption = .dates}}
            ...
            .onTapGesture {withAnimation(.snappy) {selectedOption = .guests}}
